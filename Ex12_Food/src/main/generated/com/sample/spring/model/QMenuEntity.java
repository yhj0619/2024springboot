...
public class QMenuEntity extends EntityPathBase<MenuEntity> {
    ...
    public final DateTimePath<java.time.ZonedDateTime> create_at = createDateTime("create_at", java.time.ZonedDateTime.class);
    ...
    public final DateTimePath<java.time.ZonedDateTime> updated_at = createDateTime("updated_at", java.time.ZonedDateTime.class);
